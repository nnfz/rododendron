          ...
          while (restartVpnPendingRulesRef.current) {
            ...
            if (isRulesHotReload && isTauri()) {
              try {
                ...
                const finalConfig = (await invoke('generate_config', { baseConfig: activeConfigContent, userRules, logLevel: settings.logLevel, enableTun: settings.enableTun, mtu: mtuValue, killSwitch: settings.killSwitch })) as string;
            ...
            await startVPN(activeConfigContent, activeConfigFilename, rulesToApply, settings.logLevel, settings.enableTun, settings.mtu, settings.killSwitch);
      ...
      try {
        ...
        unlistenStart = await listen('tray://start', async () => {
          ...
          try {
            ...
            await startVPN(activeConfigContent, activeConfigFilename, rules, settings.logLevel, settings.enableTun, settings.mtu, settings.killSwitch);
            setVpnRunningConfigId(activeConfigId || null);
            setRestartRequiredForConfig(false);
